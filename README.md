...
This project uses ng-zorro-antd v11.x([https://ng.ant.design](https://ng.ant.design)) as [ASP.NET Zero](https://aspnetzero.com/) front-end template. Compatible with ASP.NET zero template v8.9+.
